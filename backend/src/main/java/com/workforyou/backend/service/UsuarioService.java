...
@Service
// Implementar an interface UserDetailsService é CRÍTICO para o Spring Security
public class UsuarioService implements UserDetailsService {
    ...
    public UsuarioPerfilResponse obterPerfil(String email) {
        Usuario usuario = usuarioRepository.findByEmail(email)
        ...
        return UsuarioPerfilResponse.from(usuario, cliente, prestador);
    }
    }
