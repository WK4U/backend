...
public class PostagemControllerTest {
    ...
    public void testaRegisterCliente() throws Exception {
        Principal principal = () -> "email@teste.com";

        Usuario usuarioMock = new Usuario();
        usuarioMock.setEmail("email@teste.com");
        usuarioMock.setDocumento("12345678000199");

        when(usuarioService.getUsuarioPorEmail("email@teste.com"))
        ...
        request.setNomeServico("Serviço Teste");
        request.setTipoServico("Tipo A");
        request.setDescricaoServico("Descrição do serviço");
        request.setDescricaoPostagem("Descrição da postagem");
        request.setFoto("base64string");
    ...
    public void testaRegistrarClienteNegativo() throws Exception{
        ...
        doThrow(new RuntimeException("Falha ao salvar postagem"))
